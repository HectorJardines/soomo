...
static io_handle_t io_confgs[IO_PORT_CNT * IO_PIN_CNT_PER_PORT] = {
	//MOTOR PWM
	[IO_PWM_MOTOR_LEFT] = {GPIOA, {IO_A0, IO_MODE_ALT_FUN, IO_SPEED_FAST, IO_OPTYPE_PP, IO_RES_NOPUPD, IO_ALT_FUN_MODE1}},
	[IO_PWM_MOTOR_RIGHT] = {GPIOA, {IO_A1, IO_MODE_ALT_FUN, IO_SPEED_FAST, IO_OPTYPE_PP, IO_RES_NOPUPD, IO_ALT_FUN_MODE1}},

	//UART TX/RX
	[IO_UART_TX] = {GPIOA, {IO_A2, IO_MODE_ALT_FUN, IO_SPEED_FAST, IO_OPTYPE_PP, IO_RES_NOPUPD, IO_ALT_FUN_MODE7}},
	[IO_UART_RX] = {GPIOA, {IO_A3, IO_MODE_ALT_FUN, IO_SPEED_FAST, IO_OPTYPE_PP, IO_RES_NOPUPD, IO_ALT_FUN_MODE7}},

	//OUTPUT
	[IO_TEST_LED] = {GPIOA, {IO_A5, IO_MODE_OUTPUT, IO_SPEED_FAST, IO_OPTYPE_PP, IO_RES_NOPUPD}},
	
	//MOTOR CONTROL
	[IO_MOTORS_LEFT_CC2] = {GPIOB, {IO_B1, IO_MODE_OUTPUT, IO_SPEED_FAST, IO_OPTYPE_PP, IO_RES_NOPUPD}},
	[IO_MOTORS_LEFT_CC2] = {GPIOB, {IO_B2, IO_MODE_OUTPUT, IO_SPEED_FAST, IO_OPTYPE_PP, IO_RES_NOPUPD}},

	[IO_MOTORS_RIGHT_CC2] = {GPIOC, {IO_C2, IO_MODE_OUTPUT, IO_SPEED_FAST, IO_OPTYPE_PP, IO_RES_NOPUPD}},
	[IO_MOTORS_RIGHT_CC2] = {GPIOC, {IO_C3, IO_MODE_OUTPUT, IO_SPEED_FAST, IO_OPTYPE_PP, IO_RES_NOPUPD}},

	//UNUSED PINS PORTA
	[IO_UNUSED_2] = UNUSED_IO_CONFG(GPIOA, IO_A4), [IO_UNUSED_4] = UNUSED_IO_CONFG(GPIOA, IO_A6), [IO_UNUSED_5] = UNUSED_IO_CONFG(GPIOA, IO_A7), [IO_UNUSED_6] = UNUSED_IO_CONFG(GPIOA, IO_A8),
	[IO_UNUSED_7] = UNUSED_IO_CONFG(GPIOA, IO_A9), [IO_UNUSED_8] = UNUSED_IO_CONFG(GPIOA, IO_A10), [IO_UNUSED_9] = UNUSED_IO_CONFG(GPIOA, IO_A11), [IO_UNUSED_10] = UNUSED_IO_CONFG(GPIOA, IO_A12),
	[IO_UNUSED_11] = UNUSED_IO_CONFG(GPIOA, IO_A13), [IO_UNUSED_12] = UNUSED_IO_CONFG(GPIOA, IO_A14), [IO_UNUSED_13] = UNUSED_IO_CONFG(GPIOA, IO_A15),

	//UNUSED PINS PORTB
	[IO_UNUSED_14] = UNUSED_IO_CONFG(GPIOB, IO_B0), [IO_UNUSED_17] = UNUSED_IO_CONFG(GPIOB, IO_B3), [IO_UNUSED_18] = UNUSED_IO_CONFG(GPIOB, IO_B4), [IO_UNUSED_19] = UNUSED_IO_CONFG(GPIOB, IO_B5), 
	[IO_UNUSED_20] = UNUSED_IO_CONFG(GPIOB, IO_B6), [IO_UNUSED_21] = UNUSED_IO_CONFG(GPIOB, IO_B7), [IO_UNUSED_22] = UNUSED_IO_CONFG(GPIOB, IO_B8), [IO_UNUSED_23] = UNUSED_IO_CONFG(GPIOB, IO_B9), 
	[IO_UNUSED_24] = UNUSED_IO_CONFG(GPIOB, IO_B10), [IO_UNUSED_25] = UNUSED_IO_CONFG(GPIOB, IO_B11), [IO_UNUSED_26] = UNUSED_IO_CONFG(GPIOB, IO_B12), [IO_UNUSED_27] = UNUSED_IO_CONFG(GPIOB, IO_B13), 
	[IO_UNUSED_28] = UNUSED_IO_CONFG(GPIOB, IO_B14), [IO_UNUSED_29] = UNUSED_IO_CONFG(GPIOB, IO_B15),

	//UNUSED PINS PORTC
	[IO_UNUSED_30] = UNUSED_IO_CONFG(GPIOC, IO_C0), [IO_UNUSED_31] = UNUSED_IO_CONFG(GPIOC, IO_C1), [IO_UNUSED_34] = UNUSED_IO_CONFG(GPIOC, IO_C4), [IO_UNUSED_35] = UNUSED_IO_CONFG(GPIOC, IO_C5), 
	[IO_UNUSED_36] = UNUSED_IO_CONFG(GPIOC, IO_C6), [IO_UNUSED_37] = UNUSED_IO_CONFG(GPIOC, IO_C7), [IO_UNUSED_38] = UNUSED_IO_CONFG(GPIOC, IO_C8), [IO_UNUSED_39] = UNUSED_IO_CONFG(GPIOC, IO_C9), 
	[IO_UNUSED_40] = UNUSED_IO_CONFG(GPIOC, IO_C10), [IO_UNUSED_41] = UNUSED_IO_CONFG(GPIOC, IO_C11), [IO_UNUSED_42] = UNUSED_IO_CONFG(GPIOC, IO_C12), [IO_UNUSED_43] = UNUSED_IO_CONFG(GPIOC, IO_C13), 
	[IO_UNUSED_44] = UNUSED_IO_CONFG(GPIOC, IO_C14), [IO_UNUSED_45] = UNUSED_IO_CONFG(GPIOC, IO_C15)
};
